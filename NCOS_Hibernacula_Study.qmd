...
guides(
  fill = guide_legend(order = 1, override.aes = list(alpha = 0.9, shape = 21, color = "black", stroke = 0.8, size = 4)),  # Feature Type - points
  shape = guide_legend(order = 2, override.aes = list(size = 4, fill = "black", color = "black", stroke = 0.8)),  # Study Part - points
  linetype = guide_legend(order = 4, override.aes = list(color = "yellow", linewidth = 2))  # NCOS Boundary - lines
)
