...
expanded_deployments <- clean_study_part_2_deployments %>%
...
hourly_deployment_summary <- clean_study_part_2_joined_sequences_and_deployments %>%
  group_by(
    placename,
    camera_name,
    hour_am_pm,
...
camera_effort_by_feature <- clean_study_part_2_joined_sequences_and_deployments %>%
