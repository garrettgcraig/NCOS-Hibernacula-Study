...
nb_table_output <- modelsummary::modelsummary(
  ...
  gt::gtsave(filename = here("figures", "model_summary_nb_offset.png"))
...
#| tbl-cap: "Species List for Part 1 of the Study. Only includes wildlife identified to species level. Table is sorted number of detections." 
...
png_file  <- here("figures", "entrances_by_feature_type_table.png")
...
webshot("species_table_hourly.html", here("figures", "species_table_hourly.png"), zoom = 2, vwidth = 1800)
