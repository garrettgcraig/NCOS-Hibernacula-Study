...
species_palette_pt_2 <- setNames(
  colorRampPalette(RColorBrewer::brewer.pal(8, "Set3"))(length(lumped_species_pt_2)),
  lumped_species_pt_2
)
...
plots <- lapply(seq_along(feature_types), function(i) {
  ...
  p <- ggplot(
    ...
    geom_jitter(aes(fill = species_fill), color = "black", shape = 21, width = 0.25, alpha = 0.7, size = 4, show.legend = TRUE) +
    geom_errorbar(
